...
namespace GranDen.GameLib.Bingo
{
    ...
    public class PrizeLine2D : PrizeLine2D<string>
    {
        ...
        /// <summary>
        /// Create a bingo prize using a name identifier and <c>IntPoint2D</c> collection
        /// </summary>
        /// <param name="matchedPoints"></param>
        /// <param name="prizeName"></param>
        public PrizeLine2D(IEnumerable<IntPoint2D> matchedPoints, string prizeName) : base(matchedPoints, prizeName)
        {
        }
    ...
    public class PrizeLine2D<T>
    {
        ...
        /// <summary>
        /// Create a bingo prize using a custom Prize Object and <c>IntPoint2D</c> collection
        /// </summary>
        /// <param name="matchedPoints"></param>
        /// <param name="prizeObj"></param>
        public PrizeLine2D(IEnumerable<IntPoint2D> matchedPoints, T prizeObj)
        {
            Points = matchedPoints.ToList();
            Prize = prizeObj;
        }

        /// <summary>
        /// Create a bingo prize using a custom Prize Object and (x, y) tuple list
        /// </summary>
        /// <param name="matchedPoints"></param>
        /// <param name="prizeObj"></param>
