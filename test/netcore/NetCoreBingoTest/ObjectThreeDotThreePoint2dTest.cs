...
namespace NetCoreBingoTest
{
    public class ObjectThreeDotThreePoint2dTest
    {
        ...
        public void TestShouldGetHorizontalPrize()
        {
            ...
            var testAllRowData = test1StRowData.Concat(test2NdRowData).Concat(test3RdRowData).ToList();
        ...
        public void TestShouldGetVerticalPrize()
        {
            ...
            var testAllColData = test1StColData.Concat(test2NdColData).Concat(test3RdColData).ToList();
        ...
        public void TestShouldGetDiagonalPrize()
        {
            ...
            var testAllDiagonalData = test1DiagonalData.Concat(test2DiagonalData).ToList();
